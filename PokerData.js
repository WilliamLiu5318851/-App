...
window.PokerData.HAND_ANALYSIS_DEFINITIONS = {
  zh: {
    ...
    made_two_pair: { label: "两对 (Two Pair)", advice: "价值/保护", reason: "强牌，但在危险的牌面上要小心。" },
    over_pair: { label: "超对 (Overpair)", advice: "强力价值", reason: "强于顶对的口袋对，大力价值下注。" },
  ...
  en: {
    ...
    made_two_pair: { label: "Two Pair", advice: "Value/Protect", reason: "Strong hand, but be careful on scary boards." },
    over_pair: { label: "Overpair", advice: "Strong Value", reason: "A pocket pair stronger than the top card on board. Bet for strong value." },
